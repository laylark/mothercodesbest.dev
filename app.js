// The following firework animation derived from:
...
function setCanvasSize() {
  ...
  canvasEl.height = navbarHeight * 2;
  canvasEl.style.width = window.innerWidth + "px";
  canvasEl.style.height = navbarHeight + "px";
...
function autoClick() {
  ...
  animateParticules(anime.random(centerX + 10, centerX + 50), 0);
